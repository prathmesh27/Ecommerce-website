...
<body>
    ...
    <main class="main__content_wrapper">
        <!-- Start slider section  desktop-->
        <section class="hero__slider--section desktop-banner">
            <div class="hero__slider--inner hero__slider--activation swiper">
                <div class="hero__slider--wrapper swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg" style=" background: url(assets/img/slider/home1-slider1.png); background-repeat: no-repeat;background-attachment: scroll;background-position: center center;background-size: cover;background-color: #f0f1f5;">
                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg two" style=" background: url(assets/img/slider/home1-slider2.png); background-repeat: no-repeat;background-attachment: scroll;background-position: center center;background-size: cover;background-color: #f0f1f5;">
                            <div class="container-fluid">
                                <div class="hero__slider--items__inner">
                                        <div class="row row-cols-1">
                                            <div class="col">
        ...
        <!-- End slider section -->
        <!-- mobile-banner -->
        <section class="hero__slider--section mobile-banner">
            <div class="hero__slider--inner hero__slider--activation swiper">
                <div class="hero__slider--wrapper swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg mob-img" >
                            <img src="assets/img/slider/home1-slider1.png" alt="mobile-img">
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1__slider--bg two mob-img" >
                              <img src="assets/img/slider/home1-slider2.png" alt="mobile-img">
                        </div>
                    </div>
                </div>
                <div class="swiper__nav--btn swiper-button-next"></div>
        ...
        <section class="product__section section--padding pt-0" style="margin-top: 5rem;">
            <div class="container-fluid">
                ...
                <div class="product__section--inner " data-aos="fade-up" data-aos-duration="2000">
        ...
        <section class="banner__section section--padding pt-0">
            <div class="container-fluid">
                <div class="row row-cols-md-2 row-cols-1 mb--n28">
                    <div class="col mb-28"data-aos="fade-up" data-aos-duration="2000">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="shop.php">
                                <img class="banner__items--thumbnail__img banner__img--max__height" src="assets/img/banner/banner5.png" alt="banner-img">
                    ...
                    <div class="col mb-28"data-aos="fade-up" data-aos-duration="2000">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="shop.php">
                                <img class="banner__items--thumbnail__img banner__img--max__height" src="assets/img/banner/banner6.png" alt="banner-img">
                                <div class="banner__items--content">
        ...
        <section class="testimonial__section section--padding pt-0">
            <div class="container-fluid">
                ...
                <div class="testimonial__section--inner testimonial__swiper--activation swiper" data-aos="fade-up" data-aos-duration="2000">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
        ...
        <section class="banner__section section--padding pt-0">
            <div class="container-fluid">
                <div class="row row-cols-1" data-aos="fade-up" data-aos-duration="2000">
                    <div class="col">
                        <div class="banner__section--inner position__relative">
                            <a class="banner__items--thumbnail display-block" href="shop.php">
                                <img class="banner__items--thumbnail__img banner__img--height__md display-block" src="assets/img/banner/banner-bg2.png" alt="banner-img">
        ...
        <section class="blog__section section--padding pt-0">
            <div class="container-fluid">
                ...
                <div class="blog__section--inner blog__swiper--activation swiper" data-aos="fade-up" data-aos-duration="2000">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.php"><img class="blog__thumbnail--img" src="assets/img/blog/blog1.png" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="blog-details.php">Fashion Trends In 2021 Styles,
                                        Colors, Accessories</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.php"><img class="blog__thumbnail--img" src="assets/img/blog/blog2.png" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="blog-details.php">Meet the Woman Behind Cool
                                        Ethical Label Refor </a>
                                    </h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.php">Read more </a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.php"><img class="blog__thumbnail--img" src="assets/img/blog/blog3.png" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="blog-details.php">Lauryn Hill Could Make Tulle
                                        Skirt and Cowboy</a>
                                    </h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.php">Read more </a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.php"><img class="blog__thumbnail--img" src="assets/img/blog/blog4.png" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="blog-details.php">Fashion Trends In 2021 Styles,
