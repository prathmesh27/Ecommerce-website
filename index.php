                                        ...
                                        <div class="row row-cols-1">
                                            ...
                                            <div class="col col-md-6">
                                                <div class="slider__content">
                                                    ...
                                                    <a class="slider__btn primary__btn" href="shop.php">
                                                        Show Collection
                                            ...
                                            <div class="col col-md-6">
                                                <div class="slider__content s2" style="background: url(assets/img/product/product2.png)no-repeat;height:100%; width:100%">
                               ...
                               <div class="container-fluid">
                                    <div class="hero__slider--items__inner">
                                        <div class="row row-cols-1">
                                            ...
                                            <div class="col col-md-6 text-center d-flex justify-content-center">
                                                <div class="slider__content s2" style="background: url(assets/img/product/product2.png)no-repeat;height:100%; width:100%">
