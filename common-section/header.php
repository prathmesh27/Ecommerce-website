  <!-- Start header area -->
        <header class="header__section">
                     ...
                     <div class="offcanvas-header">
                        <div class="offcanvas__inner">
                            <div class="offcanvas__logo">
                                <a class="offcanvas__logo_link" href="index.phpphp">
                                <img src="assets/img/logo/new-logo.png" alt=" Logo" width="158" height="36">
                                </a>
                            ...
                            <nav class="offcanvas__menu">
                                <ul class="offcanvas__menu_ul">
                                    <li class="offcanvas__menu_li">
                                        <a class="offcanvas__menu_item" href="index.php">Home mob</a>
                                    </li>
                                    <li class="offcanvas__menu_li">
                                        <a class="offcanvas__menu_item" href="#">Products</a>
                                        <ul class="offcanvas__sub_menu">
                                            <li class="offcanvas__sub_menu_li">
                                                <a href="#" class="offcanvas__sub_menu_item">Category one</a>
                                                <ul class="offcanvas__sub_menu">
                                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop.php">Product 1</a></li>
                                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-right-sidebar.php">Product 2</a></li>
                                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-grid.php">Product 3</a></li>
                                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-grid-list.php">Product 4</a></li>
                                                </ul>
                                            </li>
                                                <li class="offcanvas__sub_menu_li">
                                                <a href="#" class="offcanvas__sub_menu_item">Category one</a>
            ...
            <!-- main header -->
            <div class="main__header header__sticky" style="d">
                <div class="container-fluid">
                    <div class="main__header--inner position__relative d-flex justify-content-between align-items-center" style="">
                        ...
                        <div class="main__logo">
                            <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" src="assets/img/logo/new-logo.png" alt="logo-img"></a></h1>
                        </div>  
                        <div class="  dek-no  ">
                            ...
                            <nav class="header__menu--navigation">
                                <ul class="d-flex">
                                    <li class="header__menu--items style2">
                                        <a class="header__menu--link text-white" href="index.php">Home 1
                                        </a>
                                    </li>
                                    <li class="header__menu--items mega__menu--items">
                                        <a class="header__menu--link text-white" href="shop.php">
                                            Products 
                                        ...
                                        <ul class="header__mega--menu d-flex">
                                            <li class="header__mega--menu__li">
                                                ...
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.php">Product 1</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.php">Product 2</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.php">Product 3</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.php">Product 4</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.php">Product 5</a></li>
                                                </ul>
                                            </li>
                                            <li class="header__mega--menu__li">
                                    ...
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" href="about.php">About US </a>  
                                    </li>
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" href="blog.php">Blog 
                                        </a>
                                    </li>
                                    <li class="header__menu--items">
            ...
            <!-- Start Offcanvas header menu  for mobile view-->
